...
@section('content')
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h1 class="mt-4 text-center" style="background: #f7f7f7; color: #7c795d; font-family: 'Trocchi', serif; font-size: 45px; font-weight: normal; line-height: 30px; padding: 20px 20px;  " >{{$category->name}}</h1>
          <br>
          <hr>
